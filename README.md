...
### MacOS
    ...
    php vendor/bin/codecept generate:test unit init
    vendor/bin/codecept run
    php -S 0.0.0.0:8000 src/index.php
    php -dxdebug.client_host=127.0.0.1 -dxdebug.client_port=9001 -dxdebug.discover_client_host=false -dxdebug.idekey="PHPSTORM" -dxdebug.mode=coverage,debug -S 0.0.0.0:8000 src/index.php
...
```
cd existing_repo
git remote add origin https://gitlab.itspektar.com/skocic/tegtmeier.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.itspektar.com/skocic/tegtmeier/-/settings/integrations)
